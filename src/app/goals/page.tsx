...
export default function GoalsPage() {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            {goals.length === 0 && (
                <Reveal delay={0.2}>
                    <div className={`flex flex-col items-center justify-center text-center relative min-h-[400px] w-full mx-auto ${mounted && resolvedTheme === 'dark' ? 'max-w-2xl' : 'max-w-xl'}`}>
                        <div className={`w-full flex justify-center ${mounted && resolvedTheme === 'dark' ? 'mb-6' : 'mb-8'}`}>
                            <motion.img
                                ...
                                className={mounted && resolvedTheme === 'dark'
                                    ? "w-80 sm:w-[440px] md:w-[540px] max-w-full h-auto object-contain"
                                    : "w-64 h-auto object-contain"
                                }
                                onError={(e) => {
